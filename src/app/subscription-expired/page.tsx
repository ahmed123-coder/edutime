        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription className="mt-2">
              Your subscription has expired. Please contact your organization administrator to renew your subscription and continue using the platform.
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      Your organization's subscription has expired. All features are temporarily unavailable until the subscription is renewed.
                    </p>
                  </div>
                </div>
              </div>
