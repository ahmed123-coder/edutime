...
const reviews = [
  {
    ...
    comment: "Excellente formation ! L'équipe de TechConseil Pro maîtrise parfaitement le sujet. Les exercices pratiques étaient très pertinents et nous avons pu appliquer directement les concepts dans nos projets.",
    helpful: 12,
    response: {
      date: "2024-01-16",
  ...
  },
  {
    ...
    comment: "Audit très complet et professionnel. Le rapport était détaillé avec des recommandations claires. Seul bémol : le délai de livraison un peu plus long que prévu.",
    helpful: 8,
    response: {
      date: "2024-01-11",
  ...
  },
  {
    ...
    comment: "Accompagnement exceptionnel ! L'équipe a su comprendre nos enjeux et proposer une stratégie adaptée. Les résultats sont déjà visibles après 3 mois.",
    helpful: 15,
  },
];
    ...
    <Card>
      ...
      <CardContent>
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">{review.user.company}</div>
                    </div>
        ...
        <div className="mt-8 p-6 bg-muted/50 rounded-lg text-center">
          <h3 className="font-semibold mb-2">Vous avez travaillé avec ce partenaire ?</h3>
